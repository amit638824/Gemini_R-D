...
export const toolDeclarations = [
    {
        ...
        description: 'Update what the user is doing now, what comes next, and optional location/notes.',
        parameters: {
            type: Type.OBJECT,
            properties: {
    ...
    {
        name: 'set_timer',
        description: 'Start or replace a countdown for the current activity. Use when the user says they will stay/do something for N minutes. The system will proactively re-engage before and when time is up.',
        parameters: {
            type: Type.OBJECT,
            properties: {
                label: {
    ...
    {
        name: 'extend_timer',
        description: 'Add time or set remaining time on an active timer (e.g. "give me another 10 minutes").',
        parameters: {
            type: Type.OBJECT,
            properties: {
    ...
    {
        name: 'save_order',
        description: 'Capture a customer order from voice, e.g. "James ordered 250 units for Thursday".',
        parameters: {
            type: Type.OBJECT,
            properties: {
    ...
    },
    {
        ...
        description: 'Return open tasks sorted by priority/due for verbal decision support.',
        parameters: {
            type: Type.OBJECT,
            properties: {
                criteria: {
    ...
    {
        name: 'get_day_state',
        description: 'Get current activity, timers, tasks, orders, notes and calendar snapshot.',
        parameters: {
            type: Type.OBJECT,
            properties: {},
        },
